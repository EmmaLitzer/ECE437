...
while(1):
    ...
    dev.SetWireInValue(0x03,0x20)               # A ?????????
    dev.SetWireInValue(0x04,0b10010111)         # D ??????????
    dev.UpdateWireIns()
...
dev.SetWireInValue(0x02,int(A_SAD + R,2)) #0b00111101
dev.SetWireInValue(0x03,0x02) 
dev.SetWireInValue(0x04,0b00000000) # D??
dev.UpdateWireIns()
...
while(1):
    ...
    dev.SetWireInValue(0x01,int(M_SAD + W,2)) #0b00111100
    dev.SetWireInValue(0x02,int(M_SAD + R,2)) #0b00111101
